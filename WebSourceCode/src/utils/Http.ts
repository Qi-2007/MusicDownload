...
import { LoginGetQRKey } from "@/NeteaseSDK/module/login_qr_key";
import { InitAnonimous, SearchMusicResult, } from "@/utils/type/BasicType";
import { CloudResponse } from "@/utils/type/CloudResponse";
...
export const Api = {
    ...
    initAnonimous() {
        ...
        return Api.get<InitAnonimous>("/es/initAnonimous")
    },
    ...
    //Universal Http Communicate Tunnal
    CallHttpApiGetResponse<T>(
        url = "",
        // 0 = GET 1 = POST
        method = 0,
        data = {}
