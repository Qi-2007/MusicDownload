...
class QQMusicApi(BaseApi):
    ...
    mQQCookie = ""#"qm_keyst=Q_H_L_5maPqNcB14MVYQE141GBcYcCRFpAn9ECCI9qqE5kAnIrG0jgl_1gVBg; uin=948168827;"
    ...
    def getQQMusicDownloadLinkV1(self, filename, songmid):
        ...
        d = d.json()
        info=d["queryvkey"]["data"]["midurlinfo"][0]
        print(d)
        purl = info.get('purl')
        fromtag = str(info.get('vip_downfromtag'))
        return 'http://ws.stream.qqmusic.qq.com/'+purl+'&fromtag='+fromtag
