...
#  @修改时间    : 2023-11-23 08:54:50
#  @上次修改    : 2023/11/23 下午8:54
import json
import random
import zlib
...
def testGetLink(qqmusicID='003cI52o4daJJL', platform='qq', quality='sq'):
    ...
    lowerCase = hashMd5(
        "d86b856be4a7ea7a5bc9b6c4eed46f4e" + time + "6562653262383463363633646364306534333668").lower()  # app的MD5改变了
    ...
    s8 = "{\n\t\"text_1\":\t\"" + s6 + "\",\n\t\"text_2\":\t\"" + s7 + "\",\n\t\"sign_1\":\t\"" + lowerCase + "\",\n\t\"time\":\t\"" + time + "\",\n\t\"sign_2\":\t\"" + hashMd5(
        s6.replace("\\", "") + s7.replace("\\",
                                          "") + lowerCase + time + "NDRjZGIzNzliNzEe").lower() + "\"\n}"  # 更新param
