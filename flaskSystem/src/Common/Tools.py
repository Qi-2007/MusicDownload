...
def handleQQ(music, musicFileInfo):
    ...
    # 自动匹配歌曲类型
    sourceSelect = ".flac" if music['prefix'] == "RS01" else ".flac" if music['prefix'] == "F000" else \
        ".mp3" if music['prefix'] == "M800" else ".mp3"

    link = QQApi.getQQMusicDownloadLinkV1(music['prefix']+'qi666'+sourceSelect,songmid)
    print (link)
